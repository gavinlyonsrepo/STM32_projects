...
// Description:
// Test file for ERM19264_UC1609_library, no buffer mode
...
int main(void)
{
 ...
 // unsigned char mychar ='X';
  ...
  while (1)
  {
	 ...
	 // mylcd.LCDNoBufferChar('h');
	  //mylcd.LCDNoBufferString((const unsigned char*)"hello1"); // Write a character string
	  HAL_GPIO_TogglePin(GPIOA, LD2_Pin); // PA5
